<template>
    <div class="roledialog">
        ...
        >
            <div class="form">
                <el-form ref="roleform" :model="FormData"  :rules="rules" label-width="80px">
...
<script>
    import  {addRole,updateRole}  from  '@/api/sys/hosts'
    export default {
        name: 'Roledialog',
        props:{
            dialog:Object,
        ...
        methods: {
            onSubmit(Formname) {
                ...
                this.$refs[Formname].validate((valid) => {
                    if (valid) {
                        const option = this.dialog.option=="add"?addRole(this.FormData):updateRole(this.rowdata.id,this.FormData);
                        option.then(res=>{
